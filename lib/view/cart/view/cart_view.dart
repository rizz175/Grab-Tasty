      ...
      children: [
        SizedBox(
          ...
          child: ClipRRect(
              ...
              child: Image.network( "https://i.postimg.cc/WzkV0KHy/food.jpg",fit: BoxFit.cover,width: 80,height: 80,)),
        ),
          ...
          children: [
            ...
            Text.rich(
              TextSpan(
                ...
                style:  TextStyle(
                    fontWeight: FontWeight.w300, color: ColorConstants.primaryColor),
                children: [
                  TextSpan(
        ...
        child: Column(
          ...
          children: [
            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                Texts.textMedium("Subtotal",size: 12),

        Texts.textBlock("566 INR",size: 15),

              ],
            ),
            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                Texts.textMedium("Tax fee",size: 12),

                Texts.textBlock("0.56 INR",size: 15),

              ],
            ),
            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                Texts.textMedium("Total",size: 14),

                Texts.textBlock("1566 INR"),

              ],
            ),
            const SizedBox(height: 16),
          CustomButton(onTap: (){},label: "Checkout",)
          ],
        ),
      ),
    );
