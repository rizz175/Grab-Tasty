          ...
          title: Row(children: [
            ...
            Column(
              ...
              children: [
                Row(
                  children: [
                    Texts.textNormal("Hello,  ",
                        size: 15, color: Colors.black54),
                    Texts.textBlock("Sandeep !",
                        size: 16,
                ...
                InkWell(
                  ...
                  child: Row(
                    children: [
                      ...
                      Texts.textNormal("Gulberg no 2, Pakistan  ",
        ...
        body: SafeArea(
          child: Column(
            children: [
              ...
              SpecialOffers(),Widgets.heightSpaceH1,
              tabHeader(), tabBody()],
          ),
        ),
      ),
                                        ...
                                        Container(
                                          ...
                                          child: DropdownButtonHideUnderline(
                                            ...
                                            child: DropdownButton<String>(
                                              ...
                                              hint: const Text(
                                                  'Select an option'), // Optional hint text
                                            ),
                                          ),
                                        ),
                                        Widgets.heightSpaceH1,
                                        Texts.textBlock(
                                            "(Idli, Dosa, Vada, Upma, Poha, Pongal, Appam, Kothu, Rawa Dosa,Masal Dosa)",
                                            size: 12,
                                            fontFamily: "RobotoRegular",
                                            maxline: 2,
                                            fontWeight: FontWeight.w300), Widgets.heightSpaceH1,
                                      ],
                                    ),
                                  ),
                                  Container(
                                    ...
                                    child: Texts.textBlock(
                                        "Note: Only 2 items will send per day as per chef",
                                        size: 12,
                                        fontFamily: "Roboto",
                                        maxline: 2,
                                  ...
                                  Container(
                                    ...
                                    child:Row(
                                      ...
                                      fontWeight: FontWeight.w500,color:Colors.white ,
                                          ...
                                          child:Texts.textUnderlineBlock(
                                      "Add to cart",
    ...
    return Column(
      ...
      children: [
        Expanded(
          ...
          child: Widgets.networkImage("https://i.postimg.cc/4dcBxqsx/f.jpg"),
        )),
    ...
    return Container(
      ...
      child: TabBar(
        ...
        labelStyle: const TextStyle(
            fontSize: 14.0, fontFamily: "RobotoRegular", color: Colors.black),
      ...
      children: [
        ...
        SingleChildScrollView(
          ...
          child: Row(
            children: [
              SpecialOfferCard(
                image: "https://i.postimg.cc/4dcBxqsx/f.jpg",
                category: "South Food",
                numOfBrands: 18,
                press: () {},
              ),
...
List<Product> demoProducts = [
  Product(
    id: 1,
    images: ["https://i.postimg.cc/WzkV0KHy/food.jpg"],
    colors: [
  ...
  Product(
    id: 2,
    images: [
      "https://i.postimg.cc/WzkV0KHy/food.jpg",
    ],
    colors: [
      const Color(0xFFF6625E),
      const Color(0xFF836DB8),
